...
import com.gec.system.filter.TokenAuthencationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .addFilterBefore(new TokenAuthencationFilter(redisTemplate), UsernamePasswordAuthenticationFilter.class)
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        // 正确创建 TreeSet，避免 ClassCastException
