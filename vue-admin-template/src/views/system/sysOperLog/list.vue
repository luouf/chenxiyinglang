    ...
    <div class="app-container">
         ...
         <el-row>
           <el-col :span="8">
             <el-form-item label="关 键 字">
               <el-input style="width: 35%" v-model="searchObj.title" placeholder="模块标题"></el-input>
               <el-input style="width: 35%" v-model="searchObj.operName" placeholder="操作人员"></el-input>
     ...
     <el-table
       ...
       <el-table-column prop="status" label="操作状态">
        <template slot-scope="scope">
              <span v-if="scope.row.status==1"  >正常 <i class="el-icon-success" style="color: green;"></i></span>
               <span v-if="scope.row.status==0">异常 <i class="el-icon-error" style="color: red;"></i></span>
          </template>
       </el-table-column>
