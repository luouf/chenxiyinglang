    ...
    <div class="app-container">
     ...
     <el-table
       ...
       <el-table-column prop="status" label="登录状态">
          <template slot-scope="scope">
              <span v-if="scope.row.status==0">失败 <i class="el-icon-success" style="color: red;"></i></span>
               <span v-if="scope.row.status==1">成功 <i class="el-icon-success" style="color: green;"></i></span>
          </template>
       </el-table-column>
